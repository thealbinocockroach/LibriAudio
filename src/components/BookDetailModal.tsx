...
export const BookDetailModal: React.FC<BookDetailModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'info' | 'chapters' | 'activity'>('info');
      ...
      >
        ...
        >
          ...
          <div className="overflow-y-auto p-5 sm:p-6 space-y-6 scrollbar-none flex-1">
            ...
            {/* Section Switcher Tabs: Synopsis / Chapters / True Stats */}
              ...
              <div id="book-detail-chapters-list" className="space-y-2">
                <div className="flex items-center justify-between px-1 pb-1">
                  <span className="text-[11px] text-white/50">
                    Click any chapter to play or tap the download launcher above to pick chapters.
                  </span>
                  <button
                    onClick={() => setShowChapterDownloadModal(true)}
                    className="text-xs text-[#C5A059] font-medium hover:underline flex items-center gap-1"
                  >
                    <Download className="w-3 h-3" /> Select Chapters to Download
                  </button>
                </div>
